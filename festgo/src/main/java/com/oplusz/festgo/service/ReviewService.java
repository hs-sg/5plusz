...
//	희성 작성 시작
	...
	public List<Review> readReviewVariableByPageNumAndUsername(Integer reviewNumberInList, Integer pageNum,
			String username) {
		log.debug("readVariableByPageNumAndUsername(reviewNumberInList={}, pageNum={}, username={})",
				reviewNumberInList, pageNum, username);
